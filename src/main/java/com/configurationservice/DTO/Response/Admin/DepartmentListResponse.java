...
public class DepartmentListResponse {
    ...
    public DepartmentListResponse(String message, List<Department> foundedAdmins, int page, int size) {
        this.message = message;
        this.data = new ResponseDepartmentPaginatedList(foundedAdmins, page, size);
    }

    public DepartmentListResponse(String message, List<Department> foundedAdmins) {
        this.message = message;
        this.data = new ResponseDepartmentPaginatedList(foundedAdmins);
    }
}
